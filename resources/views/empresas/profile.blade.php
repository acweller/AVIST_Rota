            ...
            @switch($contato->contato_tipo_id)
                @case(1)
                    <div class="btn-group btn-group-sm">
                        ...
                        <a href="tel:{{ addslashes($contato->descricao) }}" class="btn">{{ addslashes($contato->descricao) }}</a>
                    </div>
                    @break
                @case(2)
                    <div class="btn-group btn-group-sm">
                        <a href="https://api.whatsapp.com/send?phone=55{{ addslashes($contato->descricao) }}" class="btn fa-brands fa-whatsapp"></a>
                        <a href="https://api.whatsapp.com/send?phone=55{{ addslashes($contato->descricao) }}" class="btn">{{ addslashes($contato->descricao) }}</a>
                    </div>
                    @break
                @case(3)
                    <div class="btn-group btn-group-sm"
                        ...
                        <a href="mailto:{{ addslashes($contato->descricao) }}" class="btn">{{ addslashes($contato->descricao) }}</a>
                    </div>
                    @break
            @endswitch
            </div>
