...
class EmpresaServicosSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('empresa_servicos')->insert([
            [
                'empresa_id' => $empresa,
                'nome'       => 'Serviço de Reserva Online',
                'descricao'  => 'Clique aqui, consulte e reserve direto conosco!',
                'hiperlink'  => 'https://www.casadosespumantes.com.br/reserva-online/',
                'horario'    => 'Diariamente, pela Internet.',
                'ativo'      => true,
                'created_at' => $data,
                'updated_at' => $data,
            ...
            [
                ...
                'hiperlink'  => 'https://www.casadosespumantes.com.br/degustacao/',
                'horario'    => 'Agende sua Experiência via WhatsApp.',
                'ativo'      => true,
                'created_at' => $data,
                'updated_at' => $data,
            ],
